...
public final class CreateFunctionDefinitionAssignment_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public CreateFunctionDefinitionAssignment_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:5eba7a7f-3c32-439d-a42a-75f845216a7d(BaseFrege.intentions)", "4429572801652561447"));
  }
  @Override
  public String getPresentation() {
    return "CreateFunctionDefinitionAssignment";
  }
  @Override
  ...
  public Collection<IntentionExecutable> instances(final SNode node, final EditorContext context) {
    if (myCachedExecutable == null) {
      myCachedExecutable = Collections.<IntentionExecutable>singletonList(new CreateFunctionDefinitionAssignment_Intention.IntentionImplementation());
    }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "Create Function Definition (Assignment).";
    }
    @Override
    ...
    public IntentionDescriptor getDescriptor() {
      return CreateFunctionDefinitionAssignment_Intention.this;
    }
  }
}
