...
public class QVARID_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_36ja7h_a(EditorContext editorContext, SNode node) {
    ...
    if (renderingCondition_36ja7h_a0a(node, editorContext)) {
    ...
    if (renderingCondition_36ja7h_a2a(node, editorContext)) {
  ...
  private static boolean renderingCondition_36ja7h_a0a(SNode node, EditorContext editorContext) {
  ...
  private static boolean renderingCondition_36ja7h_a2a(SNode node, EditorContext editorContext) {
