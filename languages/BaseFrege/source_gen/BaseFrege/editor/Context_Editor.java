...
public class Context_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_d0e2am_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_d0e2am_b0(editorContext, node));
  ...
  private EditorCell createRefNodeList_d0e2am_b0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Context_Editor.partsListHandler_d0e2am_b0(node, "parts", editorContext);
  ...
  private static class partsListHandler_d0e2am_b0 extends RefNodeListHandler {
    public partsListHandler_d0e2am_b0(SNode ownerNode, String childRole, EditorContext context) {
