  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    {
      ...
      switch (switchIndex) {
        ...
        case 4:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new BlockCommentLine_Editor());
          }
          break;
        case 5:
          if (true) {
        ...
        case 76:
          if (true) {
            return Collections.<ConceptEditor>singletonList(new ResourcePart_Editor());
          }
          break;
        case 77:
          if (true) {
