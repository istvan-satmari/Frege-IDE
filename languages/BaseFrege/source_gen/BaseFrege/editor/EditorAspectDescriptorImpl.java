...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<TransformationMenu> getDeclaredNamedTransformationMenus(NamedMenuId menuId) {
    ...
    switch (index_xbvbvu_a0d.index(cncpt)) {
      ...
      case 10:
        if (true) {
          switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a0k1a3, menuId.getFqName())) {
            case 0:
              return Arrays.asList(new TransformationMenu[]{new PListColon_AddHead()});
            default:
          }
        }
        break;
      ...
      case 15:
        if (true) {
          switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a0p1a3, menuId.getFqName())) {
            case 0:
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0j1a3 = new String[]{"BaseFrege.editor.PListBrackets_AddItem"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0k1a3 = new String[]{"BaseFrege.editor.PListColon_AddHead"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0l1a3 = new String[]{"BaseFrege.editor.Type_AddTypeVariable"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0m1a3 = new String[]{"BaseFrege.editor.TypeBrackets_ChangeToTuple"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0n1a3 = new String[]{"BaseFrege.editor.TypeData_AddArgument"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0o1a3 = new String[]{"BaseFrege.editor.FunctionType_AddArgument"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0p1a3 = new String[]{"BaseFrege.editor.TypeTuple_AddAnother"};
}
