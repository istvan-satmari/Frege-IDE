...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
      ...
      case 6:
        if (true) {
          switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a0g1a3, menuId.getFqName())) {
            case 0:
              return Arrays.asList(new TransformationMenu[]{new Simpletype_Miscellaneous()});
            default:
          }
        }
        break;
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0d1a3 = new String[]{"BaseFrege.editor.Import_AddImportAsImportList", "BaseFrege.editor.Import_AddImportList"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0e1a3 = new String[]{"BaseFrege.editor.Module_AddExportedParts"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0f1a3 = new String[]{"BaseFrege.editor.NodeCONID_Miscellaneous"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0g1a3 = new String[]{"BaseFrege.editor.Simpletype_Miscellaneous"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0h1a3 = new String[]{"BaseFrege.editor.Type_AddTypeVariable"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0i1a3 = new String[]{"BaseFrege.editor.TypeBrackets_ChangeToTuple"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0j1a3 = new String[]{"BaseFrege.editor.TypeData_AddArgument"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0k1a3 = new String[]{"BaseFrege.editor.FunctionType_AddArgument"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0l1a3 = new String[]{"BaseFrege.editor.TypeTuple_AddAnother"};
}
