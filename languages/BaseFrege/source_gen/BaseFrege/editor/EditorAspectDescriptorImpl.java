...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
      ...
      case 10:
        if (true) {
          switch (Arrays.binarySearch(stringSwitchCases_xbvbvu_a0a0a0k1a4, menuId.getFqName())) {
            case 0:
              return Arrays.asList(new TransformationMenu[]{new TopExpression_AddOperator()});
            default:
          }
        }
        break;
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0k1a4 = new String[]{"BaseFrege.editor.TopExpression_AddOperator"};
