...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForBooleanValue() {
    ...
    b.class_(false, false, false);
    b.super_("BaseFrege.structure.Literal", 0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3fa4bL);
    b.origin("r:510a4f4e-9bcb-4fe8-a8a3-6e4488a35835(BaseFrege.structure)/574920793184786700");
    b.prop("value", 0x6b074f517ae2007aL, "7712220098267840634");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForFDAssignment() {
    ...
    b.aggregate("pattern", 0x5feee6d035b3dd05L).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895192L).optional(false).ordered(true).multiple(false).origin("6912716259988856069").done();
  ...
  private static ConceptDescriptor createDescriptorForFDGuards() {
    ...
    b.aggregate("pattern", 0x5feee6d035b3dd2fL).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895192L).optional(false).ordered(true).multiple(false).origin("6912716259988856111").done();
  ...
  private static ConceptDescriptor createDescriptorForLiteral() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("BaseFrege", "Literal", 0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3fa4bL);
    b.class_(false, true, false);
    b.super_("BaseFrege.structure.Term", 0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x7fa876a53c3d8edL);
    b.origin("r:510a4f4e-9bcb-4fe8-a8a3-6e4488a35835(BaseFrege.structure)/6912716259988863563");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForModule() {
    ...
    b.aggregate("name", 0x1cff861b633b5a33L).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x1cff861b633ae12dL).optional(false).ordered(true).multiple(false).origin("2089536204310272563").done();
  ...
  private static ConceptDescriptor createDescriptorForPConstructor() {
    ...
    b.aggregate("name", 0x3f5c5828a3895219L).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x7a213c18049985a6L).optional(false).ordered(true).multiple(false).origin("4565621053812462105").done();
  ...
  private static ConceptDescriptor createDescriptorForPListBrackets() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("BaseFrege", "PListBrackets", 0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a38952abL);
    b.class_(false, false, false);
    b.origin("r:510a4f4e-9bcb-4fe8-a8a3-6e4488a35835(BaseFrege.structure)/4565621053812462251");
    b.aggregate("items", 0x3f5c5828a38952acL).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895193L).optional(true).ordered(true).multiple(true).origin("4565621053812462252").done();
    b.alias("[");
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForPListDot() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("BaseFrege", "PListDot", 0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895253L);
    b.class_(false, false, false);
  ...
  private static ConceptDescriptor createDescriptorForRho() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("BaseFrege", "Rho", 0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3893019L);
    b.class_(false, false, false);
    ...
    b.aggregate("tau", 0x3f5c5828a38930c4L).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x76d2ad9a0d65ea2dL).optional(false).ordered(true).multiple(false).origin("4565621053812453572").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForTypeBrackets() {
    ...
    b.aggregate("tau", 0x3f5c5828a389309eL).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x76d2ad9a0d65ea2dL).optional(false).ordered(true).multiple(false).origin("4565621053812453534").done();
    b.alias("(");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForTypeList() {
    ...
    b.aggregate("tau", 0x76d2ad9a0d662e93L).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x76d2ad9a0d65ea2dL).optional(false).ordered(true).multiple(false).origin("8562096718746103443").done();
    b.alias("[");
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForTypeTuple() {
    ...
    b.aggregate("tau", 0x3f5c5828a3893058L).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x76d2ad9a0d65ea2dL).optional(false).ordered(true).multiple(false).origin("4565621053812453464").done();
    b.aggregate("taus", 0x76d2ad9a0d662e7aL).target(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x76d2ad9a0d65ea2dL).optional(false).ordered(true).multiple(true).origin("8562096718746103418").done();
    return b.create();
  }
