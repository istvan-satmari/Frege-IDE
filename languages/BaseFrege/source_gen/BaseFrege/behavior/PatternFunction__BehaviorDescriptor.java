...
public final class PatternFunction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895194L, "BaseFrege.structure.PatternFunction");
  ...
  public static final SMethod<List<String>> GetReservedNames_id1lrXqCCgoj2 = new SMethodBuilder<List<String>>(new SJavaCompoundTypeImpl((Class<List<String>>) ((Class) Object.class))).name("GetReservedNames").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1lrXqCCgoj2").registry(REGISTRY).build();
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(GetVariableNames_id50lglqqP9oo, GetReservedNames_id1lrXqCCgoj2, getPublicScopeFromChildren_id5c96$3RL4yv, getOwnPublicScope_id5c96$3RFA4u);
  ...
  /*package*/ static List<String> GetVariableNames_id50lglqqP9oo(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(childVariableNames).addElement(SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895194L, 0x3f5c5828a3895195L, "name")), MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895209L, 0x3f5c5828a389520aL, "name")), MetaAdapterFactory.getProperty(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x7a213c18049985e2L, 0x7a213c18049985f2L, "value")));

    // Child variable names 
    for (SNode argument : ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895194L, 0x3f5c5828a3895197L, "arguments")))) {
  ...
  /*package*/ static List<String> GetReservedNames_id1lrXqCCgoj2(@NotNull SAbstractConcept __thisConcept__) {
    List<String> reserved = ListSequence.fromListAndArray(new ArrayList<String>(), "case", "class", "data", "default", "deriving", "do", "else", "foreign", "if", "import", "in", "infix", "infixl", "infixr", "instance", "let", "module", "newtype", "of", "then", "type", "where", "_");
  ...
  /*package*/ static Scope getOwnPublicScope_id5c96$3RFA4u(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child, SNode calledBy, String restriction) {
    if (restriction != "variables") {
      ...
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895209L, "BaseFrege.structure.PVarName"))) {
        // PVarName - Function name 
        return new SimpleRoleScopePVarName(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895194L, 0x3f5c5828a3895195L, "name"));
      }
    } else if (restriction == "variables") {
      // Provide scope of the child variables 
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895209L, "BaseFrege.structure.PVarName"))) {
        CompositeScope vars = new CompositeScope();
        vars.addScope(new FilteredRoleScopePVarName(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895194L, 0x3f5c5828a3895197L, "arguments")));

        // Delegate scope creation to children (for nested variables, e.g. variable in a list [x, y, z]) 
        for (SNode singleArgument : ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895194L, 0x3f5c5828a3895197L, "arguments")))) {
  ...
  /*package*/ PatternFunction__BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 1:
        return (T) ((List<String>) GetReservedNames_id1lrXqCCgoj2(concept));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
