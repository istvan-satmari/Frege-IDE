...
public final class FDGuards__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, "BaseFrege.structure.FDGuards");
  private static final BehaviorRegistry REGISTRY = ConceptRegistry.getInstance().getBehaviorRegistry();

  public static final SMethod<SNode> convertFromFunctionDefinition_id3PT0fU4UjUS = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("convertFromFunctionDefinition").modifiers(SModifiersImpl.create(1, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3PT0fU4UjUS").registry(REGISTRY).build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(convertFromFunctionDefinition_id3PT0fU4UjUS, canGetFDGrouped_id4QVy75p5ji2, getFDGrouped_id4QVy75p411F, getNodeToSelect_id4QVy75p8CBP, getPatternWrapper_id181lOLSjrci, getPublicScopeFromChildren_id5c96$3RL4yv, getScope_id52_Geb4QDV$, getTypedDefinitionNode_id2LraaixmJl3);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static SNode convertFromFunctionDefinition_id3PT0fU4UjUS(@NotNull SAbstractConcept __thisConcept__, SNode fundef) {
    SNode guards = SNodeFactoryOperations.createNewNode(SNodeFactoryOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, "BaseFrege.structure.FDGuards")), null);
    SLinkOperations.setTarget(guards, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern"), SLinkOperations.getTarget(fundef, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x45da4fd5064877c7L, 0x79e169c6c382b4dfL, "pattern")));

    return guards;
  }
  /*package*/ static boolean canGetFDGrouped_id4QVy75p5ji2(@NotNull SNode __thisNode__) {
    return (boolean) PatternWrapper__BehaviorDescriptor.CanGetTransformedForFDGrouped_id4QVy75p4hco.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern")));
  }
  /*package*/ static SNode getFDGrouped_id4QVy75p411F(@NotNull SNode __thisNode__, boolean wrapWithFDGrouped) {
    SNode fdg = SNodeFactoryOperations.createNewNode(SNodeFactoryOperations.asInstanceConcept(MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, "BaseFrege.structure.FDGuards")), null);
    SLinkOperations.setTarget(fdg, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern"), PatternWrapper__BehaviorDescriptor.GetTransformedForFDGrouped_id4QVy75p4iaJ.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern"))));
    ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(fdg, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5feee6d035b3dd31L, "guards")), MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x2c5b28a4a146e49fL, 0x2c5b28a4a146e4a0L, "guards"))).clear();
    for (SNode guard : ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5feee6d035b3dd31L, "guards")), MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x2c5b28a4a146e49fL, 0x2c5b28a4a146e4a0L, "guards")))) {
      ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(fdg, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5feee6d035b3dd31L, "guards")), MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x2c5b28a4a146e49fL, 0x2c5b28a4a146e4a0L, "guards"))).addElement(SNodeOperations.copyNode(guard));
    }
    SLinkOperations.setTarget(fdg, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5aa4f79b7b10486fL, "where"), SNodeOperations.copyNode(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5aa4f79b7b10486fL, "where"))));
    ...
    ListSequence.fromList(SLinkOperations.getChildren(group, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x155bf5aa28426de7L, 0x155bf5aa28426dedL, "matchers"))).addElement(fdg);
    return group;
  }
  /*package*/ static SNode getNodeToSelect_id4QVy75p8CBP(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5feee6d035b3dd31L, "guards")), MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x2c5b28a4a146e49fL, 0x2c5b28a4a146e4a0L, "guards"))).getElement(0), MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x7fa876a53c3d926L, 0x5feee6d035b3dd41L, "condition"));
  }
  /*package*/ static SNode getPatternWrapper_id181lOLSjrci(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern"));
  }
  /*package*/ static Scope getPublicScopeFromChildren_id5c96$3RL4yv(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child, SNode calledBy, String restriction) {
    ...
    return DCScopeProvider__BehaviorDescriptor.getPublicScope_id5c96$3RFu09.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern")), kind, child, __thisNode__, restriction);
  }
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    ...
    // For "equalsTo" the scope also includes the "where" part and the variables from the pattern 
    if (ScopeUtils.comeFrom(MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5feee6d035b3dd31L, "guards"), __thisNode__, child)) {
      cs.addScope(DCScopeProvider__BehaviorDescriptor.getPublicScope_id5c96$3RFu09.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5aa4f79b7b10486fL, "where")), kind, child, __thisNode__, "fundef"));
      cs.addScope(DCScopeProvider__BehaviorDescriptor.getPublicScope_id5c96$3RFu09.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern")), kind, child, __thisNode__, "variables"));
    }

    // For "where" the scope also includes the variables from the pattern 
    if (ScopeUtils.comeFrom(MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5aa4f79b7b10486fL, "where"), __thisNode__, child)) {
      cs.addScope(DCScopeProvider__BehaviorDescriptor.getPublicScope_id5c96$3RFu09.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x3d7900fe84e09207L, "pattern")), kind, child, __thisNode__, "variables"));
    }
  ...
  /*package*/ static SNode getTypedDefinitionNode_id2LraaixmJl3(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x5feee6d035b3dcebL, 0x5feee6d035b3dd31L, "guards"));
  }

  /*package*/ FDGuards__BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SAbstractConcept concept, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((SNode) convertFromFunctionDefinition_id3PT0fU4UjUS(concept, (SNode) parameters[0]));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
