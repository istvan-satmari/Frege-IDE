...
public final class PConstructor__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a38951f8L, "BaseFrege.structure.PConstructor");
  ...
  public static final SMethod<Boolean> isInBrackets_id4rrDQaAlayP = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isInBrackets").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4rrDQaAlayP").registry(REGISTRY).build();

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(GetVariableNames_id50lglqqP9oo, getOwnPublicScope_id5c96$3RFA4u, isInBrackets_id4rrDQaAlayP);
  ...
  /*package*/ static List<String> GetVariableNames_id50lglqqP9oo(@NotNull SNode __thisNode__) {
    ...
    for (SNode argument : ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a38951f8L, 0x3f5c5828a389521bL, "arguments")))) {
  ...
  /*package*/ static Scope getOwnPublicScope_id5c96$3RFA4u(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child, SNode calledBy, String restriction) {
    if (FunctionDefinitionUtilities.ssnCanReturnPVarName(__thisNode__, restriction)) {
      if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a3895209L, "BaseFrege.structure.PVarName"))) {
        // PVarName - variables 
        return new FilteredRoleScopePVarName(__thisNode__, MetaAdapterFactory.getContainmentLink(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x3f5c5828a38951f8L, 0x3f5c5828a389521bL, "arguments"));
      }
    }
  ...
  /*package*/ static boolean isInBrackets_id4rrDQaAlayP(@NotNull SNode __thisNode__) {
    return SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x75a03de5fd2a22cdL, "BaseFrege.structure.PBracket"));
  }

  /*package*/ PConstructor__BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) ((Boolean) isInBrackets_id4rrDQaAlayP(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
