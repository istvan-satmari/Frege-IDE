...
public final class IITCLAll__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x1abe72387e906599L, "BaseFrege.structure.IITCLAll");
  ...
  /*package*/ static List<SNode> getReferencedNodes_id1EYszxYDYYd(@NotNull SNode __thisNode__) {
    // All constructors need to be returned for the current datatype 
    return Sequence.fromIterable(ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke(SNodeOperations.cast(SNodeOperations.getParent(SNodeOperations.getParent(__thisNode__)), MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x1abe72387e906535L, "BaseFrege.structure.IIType")), MetaAdapterFactory.getConcept(0x90eaf9a4a968473cL, 0x8aedfef10c04a5dfL, 0x608e2b4f233247d0L, "BaseFrege.structure.DataConstructor"), __thisNode__).getAvailableElements(null)).toListSequence();
  }

  /*package*/ IITCLAll__BehaviorDescriptor() {
    super(REGISTRY);
  }
